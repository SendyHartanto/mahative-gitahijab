                        ...
                        <div id="myCarouse2" class="carousel vcarousel slide p-20">
                            ...
                            <div class="carousel-inner ">
                                <div class="active item">
                                    ...
                                    <div class="twi-user"><img src="{{ asset('plugins/images/users/hritik.jpg') }}" alt="user" class="img-circle img-responsive pull-left">
                                ...
                                <div class="item">
                                    <h3 class="text-white">My Acting blown <span class="font-bold">Your Mind</span> and you also laugh at the moment</h3>
                                    <div class="twi-user"><img src="{{ asset('plugins/images/users/genu.jpg') }}" alt="user" class="img-circle img-responsive pull-left">
                                        <h4 class="text-white m-b-0">Govinda</h4>
                                        <p class="text-white">Actor</p>
                                    </div>
                                </div>
                                <div class="item">
                                    <h3 class="text-white">My Acting blown <span class="font-bold">Your Mind</span> and you also laugh at the moment</h3>
                                    <div class="twi-user"><img src="{{ asset('plugins/images/users/ritesh.jpg')   }}" alt="user" class="img-circle img-responsive pull-left">
                                        <h4 class="text-white m-b-0">Govinda</h4>
                                        <p class="text-white">Actor</p>
                                    </div>
                                </div>
            ...
            <div class="white-box">
                ...
                <div class="comment-center">
                    <div class="comment-body">
                        <div class="user-img"> <img src="{{ asset('plugins/images/users/pawandeep.jpg') }}" alt="user" class="img-circle"></div>
                    ...
                    <div class="comment-body">
                        <div class="user-img"> <img src="{{ asset('plugins/images/users/sonu.jpg') }}" alt="user" class="img-circle"> </div>
                        <div class="mail-contnet">
                            <h5>Sonu Nigam</h5>
                    ...
                    <div class="comment-body">
                        <div class="user-img"> <img src="{{ asset('plugins/images/users/arijit.jpg') }}" alt="user" class="img-circle"> </div>
                        <div class="mail-contnet">
                            <h5>Arijit Sinh</h5>
        ...
        <div class="col-md-12 col-lg-4">
            <div class="white-box">
                ...
                <div class="message-center">
                    ...
                    <a href="#">
                        <div class="user-img"> <img src="{{ asset('plugins/images/users/genu.jpg') }}" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                        <div class="mail-contnet">
            ...
            <div class="white-box">
                ...
                <div class="chat-box">
                    <ul class="chat-list slimscroll" style="overflow: hidden;" tabindex="5005">
                        <li>
                            <div class="chat-image"> <img alt="male" src="{{ asset('plugins/images/users/sonu.jpg') }}"> </div>
                            <div class="chat-body">
                                <div class="chat-text">
                                    <h4>Sonu Nigam</h4>
                                    <p> Hi, All! </p>
                        ...
                        <li class="odd">
                            <div class="chat-image"> <img alt="Female" src="{{ asset('plugins/images/users/genu.jpg') }}"> </div>
                            <div class="chat-body">
                                <div class="chat-text">
                                    <h4>Genelia</h4>
